...
<div id="intro">
    <div class="container">
        ...
        <div>
            <div align="center">
                <strong>List Barang yang Stoknya Menipis</strong><br><br>
                <table class="table table-striped">
                    <?php if ($listBarangTipis->num_rows()>0)  { ?>
                        <thead>
                        <tr style="text-align:center">
                            <td style="width:250px"><p style="font-size:1.25em">Barang</p></td>
                            <td style="width:250px"><p style="font-size:1.25em">Jumlah Barang Tersisa</p></td>
                        </tr>
                        </thead>
                    <?php } ?>
                    ...
                    <?php
                    foreach ($listBarangTipis->result() as $row) {
                        ?>

                        <tr style='text-align:center'>
                            <td style='width:250px'><p style='font-size:1em'><?php echo $row->nama_barang; ?></p></td>
                            <td style='width:250px'><p style='font-size:1em'><?php echo $row->Stok; ?></p></td>
                        </tr>
